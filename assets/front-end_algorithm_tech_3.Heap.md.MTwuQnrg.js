import{_ as i,c as a,o as n,ah as h}from"./chunks/framework.BEigD8kW.js";const g=JSON.parse('{"title":"由于 js 中没有 heap，所以这里贴出个人的实现","description":"","frontmatter":{},"headers":[],"relativePath":"front-end/algorithm/tech/3.Heap.md","filePath":"front-end/algorithm/tech/3.Heap.md"}'),p={name:"front-end/algorithm/tech/3.Heap.md"};function l(k,s,t,e,E,d){return n(),a("div",null,[...s[0]||(s[0]=[h(`<h1 id="由于-js-中没有-heap-所以这里贴出个人的实现" tabindex="-1">由于 js 中没有 heap，所以这里贴出个人的实现 <a class="header-anchor" href="#由于-js-中没有-heap-所以这里贴出个人的实现" aria-label="Permalink to “由于 js 中没有 heap，所以这里贴出个人的实现”">​</a></h1><h2 id="demo" tabindex="-1">demo <a class="header-anchor" href="#demo" aria-label="Permalink to “demo”">​</a></h2><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">class</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> MinHeap</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
